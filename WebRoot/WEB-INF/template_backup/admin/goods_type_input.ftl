...
$().ready(function() {
	...
	$.validator.addMethod("goodsAttributeListNameRequired", $.validator.methods.required, "请填写充值卡属性名称");
	$.validator.addMethod("goodsAttributeListOptionTextRequired", $.validator.methods.required, "请填写充值卡属性可选项");
	$.validator.addMethod("goodsAttributeListOrderListDigits", $.validator.methods.digits, "充值卡属性排序必须为零或正整数");
	$.validator.addMethod("goodsParameterListNameRequired", $.validator.methods.required, "请填写充值卡参数名称");
	$.validator.addMethod("goodsParameterListOrderListDigits", $.validator.methods.digits, "充值卡参数排序必须为零或正整数");
