...
<title>收件箱<#if setting.isShowPoweredInfo> - 名臣福利</#if></title>
		...
		<div class="bodyRight">
			<div class="memberCenterDetail">
				...
				<div class="middle">
					...
					<table id="messageTable" class="listTable">
						...
						<#list pager.result as message>
							<tr>
								...
								<td>
									<a href="${base}/card/message!reply.action?id=${message.id}">回复</a>
					...
					<div class="blank"></div>
					<@pagination pager=pager baseUrl="/card/message!inbox.action">
