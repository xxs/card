	...
	<#include "/WEB-INF/template/card/member_header.ftl">
		<section id="content-container" class="clearfix">
         <div id="main-wrap" class="clearfix">
            <#include "/WEB-INF/template/card/member_left_info.ftl">
            <div class="page_content_right sub-content">
                 <!-- START tabs_type_2 --> 
		         <dl class="tabs_type_2">
		            <dt class="current">修改密码</dt>
		            <dd class="current">
		               <p>推广链接：<input type="text" class="formText" value="http://127.0.0.1:8080/card/member!memberreg.action?id=${member.id}"/></p>
