...
<title>收货地址<#if setting.isShowPoweredInfo> - XXS</#if></title>
	...
	<div class="body receiverList">
		...
		<div class="bodyRight">
			<div class="memberCenterDetail">
				...
				<div class="middle">
					<div class="blank"></div>
					<a class="addButton" href="${base}/card/receiver!add.action" hidefocus>添加地址</a>
					<div class="blank"></div>
					<table id="receiverTable" class="listTable">
						...
						<#list receiverSet as receiver>
							<tr>
								...
								<td>
									<a href="${base}/card/receiver!edit.action?id=${receiver.id}">编辑</a>
