...
<body class="goodsList">
	...
	<div class="body">
		...
		<div class="bodyRight">
			<form id="goodsListForm" action="${base}/card/goods!search.action" method="post">
				...
				<div class="goodsTableList">
					...
					<@pagination pager=pager baseUrl="/card/goods!search.action" parameterMap = parameterMap>
