...
<title>草稿箱<#if setting.isShowPoweredInfo> - 名臣福利</#if></title>
				...
				<div class="middle">
					...
					<table id="messageTable" class="listTable">
						...
						<#list pager.result as message>
							<tr>
								<td>
									<a href="${base}/card/message!send.action?id=${message.id}">${message.title}</a>
								</td>
								<td>
								...
								<td>
									<a href="${base}/card/message!send.action?id=${message.id}">发送</a>&nbsp;&nbsp;
					...
					<div class="blank"></div>
					<@pagination pager=pager baseUrl="/card/message!draftbox.action">
